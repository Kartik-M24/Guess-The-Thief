...
public class SecurityAfterController extends MasterController {
  ...
  public void initialize() {
    // Sets the timer for the scene and set appropriate fields as visible and not visible depending
    // on what we neeed
  ...
  private void nextSceneLeft(MouseEvent event) throws IOException {
    ...
    scene.setRoot(SceneManager.getUiRoot(AppUi.SECURITYFOOTAGEMIDDLE));
  }
